            ...
            <div class="form-container">
                ...
                <form class="form" method="POST" onSubmit={handleLoginSubmit}>
                    <div class="input-group">
                        ...
                        <input type="name" name="name" id="name" placeholder="Enter Name" value={registerData.name} onChange={handleInputChange} />
                    </div>
                    <div class="input-group">
                        <label for="email">Email</label>
                        <input type="email" name="email" id="email" placeholder="Enter Email" value={registerData.email} onChange={handleInputChange} />
                    </div>
                    <div class="input-group">
                        <label for="password">Password</label>
                        <input type="password" name="password" id="password" placeholder="Enter Password" value={registerData.password} onChange={handleInputChange} />
                ...
                <p class="signup">Already registered?
